def main():
    ...
    about_me = {
        "full_name": "Ronit kapoor",
        "student_id": 10313647,
        "pizza_toppings": ['PANEER','ONION','CHEESE'],
        "movies": [
            {
                "title": "sufna",
                "genre": "lover"
    ...
    about_me["movies"].append({"title": "your name","genre": "conguring"})
...
def print_movie_genres(about_me):
    ...
    s = ", ".join(L)
    print(f'I like to watch {s} movies.')
    return 
...
def print_movie_titles(movie_list):
    ...
    s = ", ".join(L)
    print(f"Some of my favourite movies are {s}!")
    return
